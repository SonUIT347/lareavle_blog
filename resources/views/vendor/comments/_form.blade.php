    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @if($errors->has('message')) is-invalid @endif" name="message" rows="3" cols="50"></textarea>
                <!--<div class="invalid-feedback">
            ...
            <button type="submit" class="mt-2 px-4 py-8 rounded-5xl bg-indigo-500 hover:bg-indigo-700 text-gray-100 text-lg 
        font-extrabold">@lang('comments::comments.submit')</button>
        </form>
    </div>
</div>
<br />